...
int main(void) 
{
    ...
    cl_mem h_mem_obj = clCreateBuffer(context, CL_MEM_READ_WRITE,
    ...
    // Prikaz rezultatov
	printf("Time to build histogram from %d samples: %.2f s.\n",N,dtime()-start);
